...
def install_udev_rules(raise_exception):
	if check_root():
		shutil.copy('Labtools/calib_data/proto.rules', '/etc/udev/rules.d')
...
setup(name='LabtoolSuite',
	...
	scripts=["Labtools/bin/oscilloscope","Labtools/bin/Stream","Labtools/bin/Experiments"],
	cmdclass={'install': CustomInstall},
	test_suite='Labtools.tests'
	)
